...
const MODES = {
  cinema: {
    ...
    blobs: [
      ...
      { color: "#081228", x: "22%",  y: "65%", w: 360, h: 380 },
    ],
    ...
    feature: {
      ...
      items: [
        "The Creator — Sci-Fi · 2h 13m",
        "Dune: Part Two — Epic · 2h 46m",
        "Past Lives — Drama · 1h 46m",
      ],
    },
    aiText: "Your cinema setup is optimal. Projector at 4K, sound at 60%. Lighting set to cinematic.",
  },
  match: {
    ...
    blobs: [
      ...
      { color: "#061a0e", x: "20%",  y: "68%", w: 420, h: 400 },
    ],
    ...
    feature: {
      ...
      items: [
        "Al Hilal  2 — 1  Al Nassr  · 67′",
        "Al Ittihad  1 — 1  Al Ahli  · HT",
        "Nearest sports bar · 2 min walk",
      ],
    },
    aiText: "Al Hilal leads by 1. Match ends in ~23 min. Al Baik nearby is open until 1 AM.",
  },
  coffee: {
    ...
    blobs: [
      ...
      { color: "#1a0e06", x: "20%",  y: "70%", w: 400, h: 380 },
    ],
    ...
    feature: {
      ...
      items: [
        "Arabica Pour-Over · 8 min",
        "Cardamom Latte · 10 min",
        "Saffron Cold Brew · 6 min",
      ],
    },
    aiText: "Your preferred order: Arabica, no sugar. Ready in 8 minutes. Tap to reorder instantly.",
  },
  relax: {
    ...
    blobs: [
      ...
      { color: "#100820", x: "22%",  y: "70%", w: 440, h: 420 },
    ],
    ...
    feature: {
      ...
      items: [
        ...
        "Rain Sounds · Ambient loop",
        "Sleep Temp: 19°C active",
      ],
    },
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 36 36" fill="none">
      <defs>
        ...
        <linearGradient id="qBlue" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#93c5fd" />
          <stop offset="100%" stopColor="#2F80FF" />
        </linearGradient>
      </defs>
      <circle cx="18" cy="17" r="15" stroke="url(#qRing)" strokeWidth="2.2" />
      <rect x="10"  y="12" width="3.5" height="9"  rx="0.6" fill="url(#qBlue)" />
      <rect x="14.5" y="9" width="3.5" height="12" rx="0.6" fill="url(#qBlue)" />
      <rect x="19"  y="13" width="3.5" height="8"  rx="0.6" fill="url(#qBlue)" />
      <path d="M9 21.5 Q18 16.5 27 21.5" stroke="url(#qBlue)" strokeWidth="1.4" strokeLinecap="round" fill="none" />
      <path d="M24.5 26 L28.5 30" stroke="url(#qRing)" strokeWidth="2.2" strokeLinecap="round" />
    </svg>
  );
}
      ...
      >
        {mode.blobs.map((b, i) => (
          <motion.div
            ...
            animate={{ x: [0, 28, -16, 8, 0], y: [0, -20, 26, -8, 0], scale: [1, 1.09, 0.95, 1.05, 1] }}
            transition={{ duration: 12 + i * 4, repeat: Infinity, ease: "easeInOut", delay: i * 1.8 }}
          />
        ))}
      </motion.div>
    </AnimatePresence>
...
function Tile({ children, className = "", onClick, accentRgb, active, style = {} }) {
  return (
    <motion.div
      onClick={onClick}
    ...
    <div className="flex flex-col items-center gap-2 h-full">
      ...
      >
        ...
        <motion.div
          ...
          style={{
            background: `linear-gradient(to top, rgb(${accentRgb}), rgba(${accentRgb},0.45))`,
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1 min-w-0 pr-2">
            <p
              ...
              style={{ color: `rgba(${mode.rgb},0.65)` }}
            >
            ...
            {isActive && (
              <motion.div
                ...
                style={{
                  ...
                  border: `1px solid rgba(${m.rgb},0.32)`,
                }}
...
export default function GuestCard() {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-auto" style={{ background: "#07090F" }}>
      ...
      <div className="relative z-10 flex flex-col min-h-screen max-w-[430px] mx-auto w-full px-4 pb-10">
        ...
        >
          <div className="flex items-center gap-3">
            <QMark size={36} />
            <div>
              <div className="text-sm font-bold text-white tracking-wider leading-none">QLVIN STAY</div>
        ...
        >
          ...
          <div className="flex items-center gap-2.5 flex-wrap">
            {[
              { icon: Calendar, text: "May 23 – 26" },
              { icon: BedDouble, text: "3 nights left" },
            ].map(({ icon: Icon, text }) => (
              <div
                key={text}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs text-white/55"
        ...
        >
          ...
          {/* Sliders column — exact iOS volume pill style */}
        ...
        {/* ── Quick Action Tiles (iOS Control Center row) ───────────────────── */}
        <motion.div
        ...
        >
          ...
          >
            ...
            <p className="text-[9px] text-white/45 leading-none">WiFi</p>
            <AnimatePresence>
              {wifiVisible && (
                <motion.p
                  ...
                  className="text-[8px] font-mono text-center leading-none mt-0.5"
                  style={{ color: `rgb(${mode.rgb})` }}
                >
                  QLVIN501
                </motion.p>
              )}
          ...
          >
            ...
            <p className="text-[9px] text-white/45 leading-none">{dnd ? "DND On" : "DND"}</p>
          </Tile>
          ...
          >
            ...
            <p className="text-[9px] text-white/45 leading-none text-center">Extend</p>
          </Tile>
          ...
          >
            ...
            <p className="text-[9px] text-white/45 leading-none">Bell</p>
          </Tile>
        </motion.div>
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            style={{
              ...
              background: `rgba(${mode.rgb},0.07)`,
              border: `1px solid rgba(${mode.rgb},0.18)`,
            }}
          >
            <motion.div
